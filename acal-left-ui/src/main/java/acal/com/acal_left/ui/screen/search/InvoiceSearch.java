...
public class InvoiceSearch extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            dialogPane.setBorder(new javax.swing.border.CompoundBorder(new TitledBorder(new EmptyBorder(0,0,0,0), "JF\u006frmD\u0065sig\u006eer \u0045val\u0075ati\u006fn",TitledBorder.CENTER
            ,TitledBorder.BOTTOM,new Font("Dia\u006cog",Font
            .BOLD,12),Color.red),dialogPane. getBorder()));dialogPane. addPropertyChangeListener(
